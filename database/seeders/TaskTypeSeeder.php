...
class TaskTypeSeeder extends Seeder
{
    ...
    private const ROWS = [
        ...
        [
            'slug' => 'sa_tax_return_preparation',
            'name' => 'SA Tax Return Preparation',
            'naming_pattern' => 'SA Tax Return Preparation {tax year}',
            'service_slug' => 'self_assessment_tax_return',
            'recurrence' => 'annual',
            'deadline_source' => null,
            'deadline_manual' => true,
            'display_order' => 131,
        ...
        [
            'slug' => 'sa_tax_return_filing',
            'name' => 'SA Tax Return Filing',
            'naming_pattern' => 'SA Tax Return Filing {tax year}',
            'service_slug' => 'self_assessment_tax_return',
            'recurrence' => 'annual',
            'deadline_source' => null,
            'deadline_manual' => true,
        ...
        [
            'slug' => 'mtd_quarterly_preparation',
            'name' => 'MTD Return Preparation (Quarterly)',
            'naming_pattern' => 'MTD Return Preparation {tax year}',
            'service_slug' => 'mtd_quarterly_filing',
            'recurrence' => 'quarterly',
            'deadline_source' => null,
            'deadline_manual' => true,
            'display_order' => 133,
        ...
        [
            'slug' => 'mtd_quarterly_return_filing',
            'name' => 'MTD Return Filing (Quarterly)',
            'naming_pattern' => 'MTD Return Filing {tax year}',
            'service_slug' => 'mtd_quarterly_filing',
            'recurrence' => 'quarterly',
            'deadline_source' => null,
            'deadline_manual' => true,
        ...
        [
            'slug' => 'mtd_final_preparation',
            'name' => 'MTD Return Preparation (Final)',
            'naming_pattern' => 'MTD Return Preparation (Final) {tax year}',
            'service_slug' => 'mtd_final_declaration',
            'recurrence' => 'annual',
            'deadline_source' => null,
            'deadline_manual' => true,
            'display_order' => 135,
        ...
        [
            'slug' => 'mtd_final_filing',
            'name' => 'MTD Return Filing (Final)',
            'naming_pattern' => 'MTD Return Filing (Final) {tax year}',
            'service_slug' => 'mtd_final_declaration',
            'recurrence' => 'annual',
            'deadline_source' => null,
            'deadline_manual' => true,
